...
public class TenantAutoConfiguration implements WebMvcConfigurer {
    ...
    public DataSource tenantCenterDataSource() {
        // 创建独立的Druid数据源，不通过TenantDataSourceCreator
        com.alibaba.druid.pool.DruidDataSource dataSource = new com.alibaba.druid.pool.DruidDataSource();
        dataSource.setUrl("jdbc:mysql://localhost:3306/tenant_center?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC");
        ...
        // 设置连接池名称以便识别
        dataSource.setName("TenantCenterPool");
        
        logger.info("Created independent tenantCenterDataSource");
        return dataSource;
    }
