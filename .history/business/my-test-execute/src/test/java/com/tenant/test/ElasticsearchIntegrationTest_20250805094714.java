...
public class ElasticsearchIntegrationTest {
    ...
    public void testCreateAndFindDocument() {
        ...
        // 查询文档
        TestDocument foundDocument = crudService.findById(document.getId());
        assertNotNull(foundDocument, "应该能找到保存的文档");
        assertEquals(document.getTitle(), foundDocument.getTitle(), "文档标题应该一致");
