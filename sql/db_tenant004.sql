...
CREATE TABLE `test_case` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 COMMENT='测试用例表';

-- ----------------------------
-- Records of test_case
-- ----------------------------
BEGIN;
INSERT INTO `test_case` (`id`, `title`, `description`, `titlecn`) VALUES (1, '登录常登录111', '输入正确用户名和密码，点击登录，期望进入系统首页', NULL);
...
INSERT INTO `test_case` (`id`, `title`, `description`, `titlecn`) VALUES (29, '登录常登录1113', '输入正确用户名和密码，点击登录，期望进入系统首页', NULL);
INSERT INTO `test_case` (`id`, `title`, `description`, `titlecn`) VALUES (30, '登录功能-密码错误3', '输入正确用户名和错误密码，点击登录，期望提示密码错误', NULL);
INSERT INTO `test_case` (`id`, `title`, `description`, `titlecn`) VALUES (31, '注册功能-邮箱已注册3', '输入已注册邮箱，期望提示邮箱已存在', NULL);
COMMIT;
